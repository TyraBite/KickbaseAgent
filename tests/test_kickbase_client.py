...
class StatusLabelTests(unittest.TestCase):
    ...
    def test_two_is_verletzt(self):
        self.assertEqual(status_label(2), "Verletzt")
    ...
    def test_unconfirmed_code_falls_back_to_placeholder(self):
        self.assertEqual(status_label(1), "Status-Code 1 (Bedeutung in v4-API nicht zweifelsfrei bestaetigt)")
